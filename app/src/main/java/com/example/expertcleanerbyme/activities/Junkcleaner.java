...
import com.example.expertcleanerbyme.task.OverallScanTask;
import com.example.expertcleanerbyme.task.ProcessScanTask;
import com.example.expertcleanerbyme.task.SysCacheScanTask;
import com.example.expertcleanerbyme.utils.CleanUtil;
import com.example.expertcleanerbyme.view.ListHeaderView;
import com.example.model.JunkGroup;
...
public class Junkcleaner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_junkcleaner);
...
//            Toast.makeText(this, ""+recentTasks.get(i).baseActivity.toShortString()+ "\t\t ID: "+recentTasks.get(i).id+"", Toast.LENGTH_SHORT).show();
//        }
                ...
                switch (msg.what) {
                    ...
                    case MSG_SYS_CACHE_CLEAN_FINISH:
                        ...
                        if (bundle != null) {
                            ...
                            if (hanged) {
                                Toast.makeText(Junkcleaner.this, "An exception occurred in cleaning the system cache!", Toast.LENGTH_SHORT)
                                        .show();
                            }
                        }
                        break;
       ...
       // mCleanButton.setEnabled(true);
        mCleanButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              //  mCleanButton.setEnabled(true);
                Toast.makeText(Junkcleaner.this, "DDDD", Toast.LENGTH_SHORT).show();
                clearAll();
            }
        });
